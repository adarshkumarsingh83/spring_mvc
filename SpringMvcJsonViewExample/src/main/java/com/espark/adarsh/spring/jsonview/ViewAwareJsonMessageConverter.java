package com.espark.adarsh.spring.jsonview;

import com.espark.adarsh.spring.view.DataView;
 ...
 *  {@link com.espark.adarsh.spring.annotation.ResponseView} annotation
 */
...
public class ViewAwareJsonMessageConverter extends
    ...
    public ViewAwareJsonMessageConverter(){
        ...
        super.setObjectMapper(defaultMapper);
    }
